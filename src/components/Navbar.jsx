...
const Navbar = () => {
  ...
  return (
    <div
      className={`navbar z-50 fixed top-0 left-0 w-full px-4 md:px-8 transition-all duration-300 ${
        isScrolled
    ...
    >
      ...
      <div className="navbar-start">
        <Link to="/" className="flex items-center gap-2">
          <img src="https://i.ibb.co/G4j8w7JK/logo.png" alt="HobbyHub" className="h-8 w-8" />
          <span className="text-xl font-bold text-purple-700 hidden sm:inline">HobbyHub</span>
        </Link>
      </div>
      ...
      <div className="dropdown lg:hidden">
        ...
        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-purple-100 rounded-box w-52 text-purple-800">
          <li><NavLink to="/">Home</NavLink></li>
          <li><NavLink to="/auth/allGroup">All Groups</NavLink></li>
          <li><NavLink to="/auth/createGroup">Create Group</NavLink></li>
          <li><NavLink to="/auth/myGroup">My Groups</NavLink></li>
